...
public class LDAPGroupAuthorizationProvider implements AuthorizationProvider
{
    ...
    {
    	this(System.getProperty(ConfigurePropertyConstants.LDAP_URL),
    			System.getProperty(ConfigurePropertyConstants.LDAP_GROUP_BASE));
    }
    ...
    public Authorizations getAuthorizations(final Subject user) throws Exception
    {
        ...
        try
        {
            ...
            // Search all group
            final String name = SecurityManager.getSubjectName(user);
