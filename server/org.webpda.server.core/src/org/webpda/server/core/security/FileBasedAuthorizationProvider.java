...
{
    final private Map<String, List<Pattern>> rules = new HashMap<String, List<Pattern>>();
    ...
    {
        this(System.getProperty(ConfigurePropertyConstants.AUTHORIZATION_CONFIG_FILE));
    }
    ...
    public FileBasedAuthorizationProvider(final InputStream config_stream) throws Exception
    {
        ...
        for (String authorization : settings.stringPropertyNames())
        {
            ...
            final List<Pattern> patterns = new ArrayList<Pattern>(auth_setting.length);
    ...
    {
        final Set<String> authorizations = new HashSet<String>();
